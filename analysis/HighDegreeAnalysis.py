...
from analysis.analysis import display_performance, cached_query_graph
import pandas as pd
...
if __name__ == "__main__":
    # Call analyze_query_times for high-degree nodes
    high_degree_results = analyze_query_times(df, (700, 2000))
